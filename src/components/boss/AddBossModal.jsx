...
export default function AddBossModal({ isOpen, onClose }) {
    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            {/* Header - Sekarang Merah sesuai tema */}
            ...
            <div className="space-y-5">
              ...
              {/* Action Buttons - Ukuran dikecilkan */}
              <div className="grid grid-cols-2 gap-3 mt-8">
                <button
                  onClick={onClose}
                  className="w-full bg-zinc-900 hover:bg-zinc-800 text-zinc-500 font-bold py-2.5 rounded-lg transition uppercase tracking-wider text-[11px]"
                >
                  Cancel
                </button>
                <button
                  onClick={handleAdd}
                  className="w-full bg-red-700 hover:bg-red-600 text-white font-extrabold py-2.5 rounded-lg transition shadow-md shadow-red-900/20 uppercase tracking-wider text-[11px]"
                >
                  Save Boss
                </button>
              </div>
